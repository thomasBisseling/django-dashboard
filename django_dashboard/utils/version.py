# This file is heavily inspired by (read: copied from) wagtail.utils.version
...
def get_complete_version(version=None):
    """
    Return a tuple of the Four Auctions version. If version argument is non-empty,
    check for correctness of the tuple provided.
    """
    if version is None:
        from django_dashboard import VERSION as version
    else:
